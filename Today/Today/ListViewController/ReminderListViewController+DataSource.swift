...
//  Today
//
//  Created by Jorge García Mateos on 8/8/22.
//
...
extension ReminderListViewController {
    ...
    func cellRegistrationHandler(cell: UICollectionViewListCell, indexPath: IndexPath, id: Reminder.ID) {
        ...
        cell.accessibilityValue = reminder.isComplete ?? false ? reminderCompletedValue : reminderNotCompletedValue
    ...
    private func doneButtonAccesibilityAction(for reminder: Reminder) -> UIAccessibilityCustomAction {
        let name = NSLocalizedString("Toggle completion", comment: "Reminder done button accesibility label")
    ...
    private func doneButtonConfiguration(for reminder: Reminder) -> UICellAccessory.CustomViewConfiguration {
        let symbolName = (reminder.isComplete ?? false) ? "circle.fill" : "circle"
