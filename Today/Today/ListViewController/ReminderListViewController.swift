...
//  Today
//
//  Created by Jorge García Mateos on 29/7/22.
//
...
class ReminderListViewController: UICollectionViewController {
    ...
    var filteredReminders: [Reminder] {
        return reminders.filter { listStyle.shouldInclude(date: $0.dueDate) }.sorted(by: { $0.dueDate < $1.dueDate })
    }
    ...
    var progress: CGFloat {
        ...
        let progress = filteredReminders.reduce(0.0) {
            let chunk = $1.isComplete ?? false ? chunkSize : 0
            return $0 + chunk
        }
        return progress
    }
    ...
    override func viewDidLoad() {
        ...
        collectionView.backgroundColor = .init(named: "TodayGradientFutureBegin")
